...
%% INITIALIZE
if nargin < 1, dir_master = uigetdir(pwd,'Choose a master directory for analysis outputs'); end
...
%% ESTIMATE AND PLOT ETo
estimate_et0_master(dir_master)
